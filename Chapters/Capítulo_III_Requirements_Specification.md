...
| 15      | TS02          | Búsqueda de Líneas de Bus                                                 | Como desarrollador, quiero crear un endpoint para buscar líneas de bus por nombre, para que los usuarios puedan encontrar rápidamente las rutas que necesitan.                                                                                                                                                                                                                                         | 2            |
...
| 17      | TS04          | Listado de Paraderos de una Línea de Bus                                  | Como desarrollador, quiero crear un endpoint que devuelva la lista de paraderos de una línea de bus específica, para que los usuarios puedan ver todos los paraderos disponibles para esa línea en la aplicación móvil.                                                                                                                                                                                | 2            |
...
| 30      | TS14          | Suscripción Premium                                                       | Como desarrollador, quiero implementar un endpoint /api/subscriptions/premium/purchase que gestione la compra de suscripciones premium por parte de los usuarios, para que los usuarios puedan acceder a funcionalidades avanzadas y mejorar su experiencia con la aplicación.                                                                                                                         | 4            |
